...
{#if showModal}
            ...
            <div class="modal-content" in:fly={{ y: -50, duration: 300 }}>
                <div class="modal-header purple-500 text-white">
                    <h5 class="modal-title">
                        <i class="bi bi-{editingProveedor ? 'pencil' : 'plus-circle'} me-2"></i>
                                    ...
                                    <div class="card-body py-3">
                                        <div class="form-check form-switch">
                                            ...
                                            <label class="form-check-label fw-semibold" for="activo">
                                                <i class="bi bi-{formData.activo ? 'check-circle-fill text-success' : 'x-circle-fill text-secondary'} me-1"></i>
                                                Proveedor {formData.activo ? "activo" : "inactivo"}
                                            </label>
                                            <div class="form-text">
                                                {formData.activo ? "Este proveedor aparecerá en las listas activas" : "Este proveedor estará inactivo y no aparecerá en las búsquedas"}
                                            </div>
                                        </div>
                                    </div>
                                </div>
    ...
    <button aria-label="button" class="modal-backdrop fade show" on:click={onClose}></button>
{/if}
