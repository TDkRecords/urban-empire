            ...
            <div class="card h-100 shadow-sm product-card">
                ...
                <div class="card-body d-flex flex-column">
                    ...
                    {#if producto.descripcion}
                        <p class="card-text text-muted small mb-3 flex-grow-1 text-truncate-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="d-flex justify-content-between align-items-center mb-1">
                            ...
                            <strong class="text-success">{formatCurrency(producto.precio)}</strong>
                        </div>
                        <div class="d-flex justify-content-between align-items-center">
                            <small class="text-muted">Stock:</small>
                            <span class="badge bg-{producto.stock > 10 ? 'success' : producto.stock > 0 ? 'warning text-dark' : 'danger'}">
