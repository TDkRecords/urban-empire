        ...
        <div class="col-12">
            ...
            {:else if !auth.currentUser}
                <div class="text-center py-5" in:fade>
                    <svg
                        ...
                        height="64"
                        fill="currentColor"
                        class="bi bi-person-x mb-3 text-muted"
                        viewBox="0 0 16 16"
                    >
                        <path
                            d="M11 5a3 3 0 1 1-6 0 3 3 0 0 1 6 0ZM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4Zm.256 7a4.5 4.5 0 0 1-.229-1.004H3c.001-.246.154-.986.832-1.664C4.484 10.68 5.711 10 8 10c.26 0 .507.009.74.025.226-.341.496-.65.811-.934C8.878 8.837 8.475 9 8 9c-5 0-6 3-6 4s1 1 1 1h5.256Z"
                        />
                        <path
            ...
            {:else if cartItems.length === 0}
                <div class="text-center py-5" in:fade>
                    <svg
                        ...
                        height="64"
                        fill="currentColor"
                        class="bi bi-cart-x mb-3 text-muted"
                        viewBox="0 0 16 16"
                    >
                        <path
            ...
            {:else}
                    ...
                    <table class="table">
                                ...
                                <tr in:fly={{ y: 20, duration: 300 }}>
                                    <td data-label="Producto">
                                        <div class="d-flex align-items-center">
                                            ...
                                            />
                                            <div>
                                                <h6 class="mb-0 FontTitle">
                                                    {item.title || item.nombre}
                                                </h6>
                                                {#if item.categoria}
                                                    <small class="text-muted"
                                                        >{item.categoria}</small
                                                    >
                                                {/if}
                                                <small
                        ...
                        <tfoot>
                            <tr>
                                ...
                                >
                                <td colspan="2"
                                    ><strong>{formatPrice(total)}</strong></td
                                >
                            </tr>
                        </tfoot>
                    </table>
                ...
                <div class="card mt-4 shadow-sm">
                    <div class="card-body">
                        <h5 class="card-title FontTitle mb-3">
                            Resumen de Compra
                        </h5>
